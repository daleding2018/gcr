...
public class MyUserAuthenticationConverter implements UserAuthenticationConverter {
    ...
    public Map<String, ?> convertUserAuthentication(Authentication authentication) {
        ...
        response.put("employee_id",username);
        response.put("englishname",myUserDetails.getEnglishname());
        response.put("chinesename",myUserDetails.getChinesename());
        response.put("email",myUserDetails.getEmail());
        response.put("company",myUserDetails.getCompany());
